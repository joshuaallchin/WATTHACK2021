...
#define AMS2_ADDRESS_0  (0x60)
#define AMS2_ADDRESS_1  (0x70)

//Adafruit_MotorShield AFMS0 = Adafruit_MotorShield(AMS2_ADDRESS_0);
Adafruit_MotorShield AFMS1 = Adafruit_MotorShield(AMS2_ADDRESS_1);
...
void setup() {
  ...
  m[0] = AFMS1.getStepper(STEPS_PER_TURN, 1);
  m[1] = AFMS1.getStepper(STEPS_PER_TURN, 2);
